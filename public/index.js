    ...
    try {
        ...
        uniqueData.forEach(crypto => {
            ...
            cryptoElement.innerHTML = `
                ...
                <p class="${priceChangeClass}"><span class="label">Price Change 24h:</span> <span class="value">$${crypto.price_change_24h.toLocaleString()}</span></p>
                <p class="${priceChangeClass}"><span class="label">Price Change Percentage 24h:</span> <span class="value">${crypto.price_change_percentage_24h}% ${priceChangeArrow}</span></p>
            `;
